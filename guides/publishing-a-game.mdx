...
<Card title="Host your game on Github pages" icon="lightbulb" iconType="duotone">
  Follow [this guide](/guides/host-your-game) to compile your game to WebGL  and host the build on Github pages
</Card>
...
<div style={{position: 'relative', paddingBottom: '62.5%', height: 0}}><iframe src="https://www.youtube.com/embed/J4W3vzal5_I" frameBorder={0} webkitallowfullscreen mozallowfullscreen allowFullScreen style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%'}} /></div>
