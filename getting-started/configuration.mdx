...
_android:scheme="unitydl" should match the value defined in the wallet configuration_
...
_the defined schema should match the value defined in the wallet configuration_
